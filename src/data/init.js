...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const auto = new sequelize_auto_1.default(database.sequelize, 'yncpbtnklwlult', '1b983e0103400943db2b5e10367d572b3c5912103e136c5fbb3ff0f5f5bc1d89', { caseFile: 'l', caseModel: 'p', caseProp: 'c', directory: './models', singularize: false, useDefine: true, lang: 'ts' });
        auto.run().then(data => {
